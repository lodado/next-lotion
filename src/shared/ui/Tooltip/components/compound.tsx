...
export const TooltipContent = ({
  ...
  return (
    <Portal>
      <Content
        className="flex z-tooltip rounded gap-spacing-3 flex-start pt-spacing-1 pb-spacing-1 pl-spacing-3 pr-spacing-3 detail-02-r bg-background-default shadow-tooltip fill-background-default"
        side="top"
        align={align}
        {...rest}
      >
